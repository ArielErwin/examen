		...
		do {
		  ...
		  switch(option) {
			  ...
			  case 2: {
				  ...
				  System.out.println("2.-) Listar por orden alfabetico de Z a A");
				  System.out.println("3.-) Listar por nota maxima");
				  System.out.println("4.-) Mostrar solo reprobados");
				  System.out.println("5.-) Mostrar nota por mejores parciales");
				  System.out.println("6.-) Mostrar solo aprobados");
				  option = Integer.parseInt(read.nextLine()) ;	
				  switch (option) {
				  case 1:{
				  ...
				  case 2:{
					  ArrayList<Student> list=management.ShowOrderZA();
					  list.forEach((Student item) -> {
					  System.out.println(item.getId()+ " .-)" + item.getLastname()+ " "+ item.getName()+ " "+
					  item.getEmail()+ " : "+
					  item.getGrade().getP1()+ " | "+
				  ...
				  case 5 :{
					  ArrayList<Student> list=management.ShowMejoresParciales();
					  list.forEach((Student item) -> {
					  System.out.println(item.getId()+ " .-)" + item.getLastname()+ " "+ item.getName()+ " "+
					  item.getEmail()+ " : "+
					  item.getGrade().getP1()+ " | "+
